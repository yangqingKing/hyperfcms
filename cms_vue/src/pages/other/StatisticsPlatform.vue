...
export default {
  ...
  methods: {
    initChart() {
      this.chartPlatform = echarts.init(document.getElementById('main'))
    ...
    async loadChartData(condition) {
      this.chartPlatform.clear()
      this.dataList = []
      this.loadingStatus = true
      let info = await this.$api.getPlatformData(condition)
      if(info.series){
