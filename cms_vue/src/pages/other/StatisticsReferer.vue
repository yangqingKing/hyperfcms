...
export default {
  ...
  methods: {
    initChart() {
      this.chartReferer = echarts.init(document.getElementById('main'))
    ...
    async loadChartData(condition) {
      this.chartReferer.clear()
      this.dataList = []
      this.loadingStatus = true
      let info = await this.$api.getRefererDataForDay(condition)
      ...
      this.chartReferer.setOption(option)
    }
  },
